        ...
        <div className="container">
            <div className="row gx-0">
                ...
                <div className="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div className="btn-light d-flex flex-column p-5" style={{height: "300px"}}>
                        <h3 className="text-lightgray  mb-3">Make Appointment</h3>
                        <p className="text-lightgray">Ipsum erat ipsum dolor clita rebum no rebum dolores labore, ipsum magna at eos et eos amet.</p>
                        <h2 className="text-lightgray mb-0">+012 345 6789</h2>
                    </div>
                </div>
            </div>
        </div>
